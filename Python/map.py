# Let's learn some new Python concepts! You have to generate a list of the first  N
# fibonacci numbers, 0 being the first number. Then, apply the map function and a 
...
# returns the result. It takes two parameters: first, the function that is to 
# be applied and secondly, the iterables.
...
# In simple words, it is a function that has only one line in its body. It proves very 
# handy in functional and GUI programming.
